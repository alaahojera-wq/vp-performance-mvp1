...
# --- Auth (demo) ---
USERS = {
    "admin@local": {"password": "admin123", "role": "admin"},
    "principal@local": {"password": "principal123", "role": "principal"},
    "vp@local": {"password": "vp123", "role": "vp"},
}
...
def html_page(title: str, body: str, user: Optional[dict] = None) -> HTMLResponse:
    ...
    if user:
        ...
        <div class="topbar">
          ...
          <div class="userbox">{user['email']} • {user['role']} &nbsp; <a href="/dashboard">Dashboard</a> &nbsp; <a href="/logout">Logout</a></div>
        </div>
        """
    html = f"""<!doctype html>
<html>
